...
public class MultichatServer {
	//클라이언트 접속 정보를 저장하는 Map 컬렉션 (key- 접속대화명, value-DataOutputStream)
	...
	public void start() {
		...
		try {
			...
			serverSocket.bind(new InetSocketAddress("192.168.0.15",7777));
	...
	class ServerReceiver extends Thread {
				...
				ServerReceiver(Socket socket){//클라이언트 요청 수락시에 생성된 socket을 전달받음
						this.socket = socket;
						try {
